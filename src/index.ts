...
program
  ...
  .option('--spec <path>', 'Path to spec file (omit for interactive mode)')
  .option('--base-repo <path>', 'Use existing project as base for each universe')
  .option('--universes <number>', 'Number of universes', '2')
  ...
  .option('--pollen-interval <min>', 'Pollen minimum interval in minutes', '1')
  ...
  .option('--slack', 'Enable Slack notifications (disabled by default)')
